...
def bin_rbc_oscillations(
    ...
    logging.debug("Gas k0 data shape: %s", data_gas_k0.shape)
    ...
    plt.savefig("tmp/png/Smoothedk0.png")
    ...
    if method == constants.BinningMethods.BANDPASS:
        ...
        logging.debug("RBC k0 data mean: %s", bias)

        plt.figure(figsize=(10, 6))
        plt.plot(data_rbc_k0_proc, label="Data")
        plt.title("Normalized and Detrended RBC k0")
        plt.savefig("tmp/png/normalizedk0.png")
        ...
        plt.savefig("tmp/png/bandpassedk0.png")

        k0_sine_fit_data, _ = signal_utils.fit_sine(data_rbc_k0_proc,
        ...
        plt.savefig("tmp/png/sinefitk0.png")
        ...
        data_rbc_k0_proc, _ = signal_utils.fit_sine(data_rbc_k0_proc,
                                                np.linspace(0, 15, data_rbc_k0_proc.size))
    else:
